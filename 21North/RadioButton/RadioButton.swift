...
//  21North
//
//  Created by Aruna Elangovan on 02/04/18.
...
class RadioButton: UIButton {
    ...
    fileprivate var radioImageView = UIImageView()
    ...
    /**
     Color of the radio button circle. Default value is UIColor orange.
     */
    ...
    /**
     Color of the radio button stroke circle. Default value is UIColor orange.
     */
    ...
    fileprivate func initialize() {
        ...
        radioImageView.autoPinEdgesToSuperviewEdges()
        self.toggleButon()
    }
    /**
    ...
    func toggleButon() {
        if self.isSelected {
            ...
            radioImageView.backgroundColor = UIColor.lightGray
        } else {
            //            fillCircleLayer.fillColor = UIColor.clear.cgColor
            //            circleLayer.strokeColor = strokeColor.cgColor
